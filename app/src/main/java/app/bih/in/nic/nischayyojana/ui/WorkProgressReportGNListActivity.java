...
import app.bih.in.nic.nischayyojana.entity.WorkProgressReportListGNViewAdapter;
import app.bih.in.nic.nischayyojana.entity.WorkProgressReportGNProperty;


public class WorkProgressReportGNListActivity extends AppCompatActivity {
    ...
    String ids,userid;
    WorkProgressReportListGNViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new WorkProgressReportListGNViewAdapter(this);
        ...
        final ArrayList<WorkProgressReportGNProperty> WorkList = getLocalPendingView(userid,_SchemeCode);
    ...
    {
        Intent i=new Intent(WorkProgressReportGNListActivity.this, LoginActivity.class);
        finish();
        startActivity(i);
    }
