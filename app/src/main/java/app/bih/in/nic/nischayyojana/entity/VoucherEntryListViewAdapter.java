...
public class VoucherEntryListViewAdapter extends BaseAdapter{

	private Context mContext;
	private LayoutInflater mLayoutInflater;
	private ArrayList<VoucherEntryProperty> mEntries = new ArrayList<>();
	String _WardCode,_WardName,_FYearCode,_SchemeName,_SchemeCode;
	//TextView lblListViewHeader;
	public VoucherEntryListViewAdapter(Context context) {
		mContext = context;
			...
			public void onClick(View v) {
				...
				ab.setPositiveButton("हाॅं ", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int whichButton) {
						...
						final ArrayList<VoucherEntryProperty> entries = getLocalPendingView(userid,_SchemeCode);
...
//				}
		...
		tvMileStone.setText(String.valueOf(mEntries.get(position).getReceiverName()));
		txtNumOfHouse.setText(String.valueOf(mEntries.get(position).get_Purpose()));
	...
	public void upDateEntries(ArrayList<VoucherEntryProperty> entries) {
		mEntries = entries;
